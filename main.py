...
def sync_playlist(playlists, dst_dir, remove_unmatched=False):
    # Get music list
    ...
    for f in progress:
        ...
        target_path = os.path.join(dst_dir, os.path.dirname(f))
...
def sync_lyrics(src_dir, dst_dir):
    pass
